...
function $c(e, n, t, r, l, o, u, i, s) {
    (Ct = !1), (Or = null), jc.apply(Uc, arguments);
}
...
function ef(e, n, t, r, l) {
    switch (n) {
        ...
        case "gotpointercapture":
            return (
                (o = l.pointerId),
                Ft.set(o, dt(Ft.get(o) || null, e, n, t, r, l)),
                !0
            );
    }
    return !1;
...
function tu(e, n, t, r) {
    if (Fr) {
        var l = mo(e, n, t, r);
        if (l === null) Il(e, n, r, jr, t), Ju(e, r);
        else if (ef(l, e, n, t, r)) r.stopPropagation();
        else if ((Ju(e, r), n & 4 && -1 < bc.indexOf(e))) {
            for (; l !== null; ) {
                var o = qt(l);
                if (
                    (o !== null && zs(o),
    ...
    rl = A({}, Jt, {
        ...
        movementX: function (e) {
            return "movementX" in e
                ...
                : (e !== mt &&
                      (mt && e.type === "mousemove"
                          ? ((Nl = e.screenX - mt.screenX),
                            (Pl = e.screenY - mt.screenY))
                          : (Pl = Nl = 0),
                      (mt = e)),
                  Nl);
        },
...
function ii() {
    xt && (xt.detachEvent("onpropertychange", As), (Ut = xt = null));
}
function As(e) {
    if (e.propertyName === "value" && ll(Ut)) {
        var n = [];
        Us(n, Ut, e, qo(e)), ws(Of, n);
    }
}
function Df(e, n, t) {
    e === "focusin"
        ? (ii(), (xt = n), (Ut = t), xt.attachEvent("onpropertychange", As))
        : e === "focusout" && ii();
}
function If(e) {
    ...
    ws(function () {
        ...
        if (!(n & 7)) {
            ...
            N &&
                ...
                (_ = Ur(c, N)),
                0 < _.length &&
                    ((N = new ni(N, e, null, t, m)),
                    v.push({ event: N, listeners: _ }),
                    x
                        ? (N.data = x)
                        : ((x = js(t)), x !== null && (N.data = x)))),
                (x = zf ? Lf(e, t) : Tf(e, t)) &&
...
function vn() {
    if (!jl && Ae !== null) {
        ...
        try {
            ...
            throw (Ae !== null && (Ae = Ae.slice(e + 1)), Cs(bo, vn), l);
        } finally {
            (O = n), (jl = !1);
        }
    }
...
function ua(e) {
    ...
    function g(f, a, d, h, E) {
        ...
        if (typeof h == "object" && h !== null) {
            ...
            if (wt(h) || ct(h))
                return (f = f.get(d) || null), m(a, f, h, E, null);
            mr(a, h);
        }
        return null;
    }
...
function Ca(e, n, t) {
    return Pn & 21
        ? (Oe(t, n) ||
              ((t = Ns()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
          n)
...
function Mi(e, n, t, r, l) {
    ...
    if ((Gn(n, l), n.stateNode === null))
        Pr(e, n), oa(n, t, r), Po(n, t, r, l), (r = !0);
    else if (e === null) {
        var u = n.stateNode,
            i = n.memoizedProps;
        u.props = i;
...
function Re(e, n, t, r) {
    if (50 < Tt) throw ((Tt = 0), ($o = null), Error(y(185)));
    Zt(e, t, r),
        (!(R & 2) || e !== Z) &&
...
function de(e, n) {
    ...
    if (r === 0)
        ...
        if ((t != null && Zu(t), n === 1))
            e.tag === 0 ? Jf(Bi.bind(null, e)) : qs(Bi.bind(null, e)),
                Yf(function () {
                    !(R & 6) && vn();
                }),
                (t = null);
...
function Wa(e, n) {
    ...
    if (n !== 0) {
        if (
            (n === 2 && ((l = fo(e)), l !== 0 && ((r = l), (n = Ao(e, l)))),
            n === 1)
        )
            throw ((t = Xt), Cn(e, 0), be(e, r), de(e, W()), t);
        if (n === 6) be(e, r);
        else {
            if (
...
function Bi(e) {
    ...
    if (t === 1) throw ((t = Xt), Cn(e, 0), be(e, n), de(e, W()), t);
...
function Sd(e, n, t) {
    ...
    r !== null && r.delete(n),
        ...
        Z === e &&
            (q & t) === t &&
            (Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > W() - Pu)
                ? Cn(e, 0)
                : (Nu |= t)),
        de(e, n);
}
...
ys = zu;
gs = Ln;
var Ld = { usingClientEntryPoint: !1, Events: [qt, Un, ul, vs, hs, zu] },
    yt = {
...
function Rd() {
    const [e, n] = Jn.useState(JSON.parse(localStorage.getItem("Notes")) || []),
        t = () => {
    ...
    const r = () => {
            let c = Math.random() * 999;
            for (; e.find((m) => m.noteid == c); ) c = Math.random() * 999;
            return c;
        },
        l = () => {
            n((c) => [
        ...
        o = (c) => {
            n(e.filter((m) => m.noteid != c));
        },
        u = (c, m) => {
            (e.find((v) => v.noteid == c).title = m.target.textContent), t();
        },
        i = (c, m) => {
            (e.find((v) => v.noteid == c).text = m.target.innerHTML), t();
        },
        s = (c) =>
            Au("div", {
                className: c.noteid + " card",
                style: { filter: c.hue },
                children: [
                    Ue("div", {
                        className: " title",
                    ...
                    Ue("h5", { children: c.date }),
                ],
            });
    return Au(xc, {
        children: [
            Ue("h1", { children: "My Notes" }),
            Ue("div", {
                className: "cards",
                id: "noteslist",
                children: e.map((c) => Ue(s, { ...c }, c.noteid)),
            }),
            Ue("button", { className: "addnew", onClick: l, children: "+" }),
        ],
    });
}
Kl.createRoot(document.getElementById("root")).render(Ue(Rd, {}));
